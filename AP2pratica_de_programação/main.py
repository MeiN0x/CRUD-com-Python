...
# Comprando motos -------------------------------------------------------------------------------------------------
        ...
        with open('cadastro_motos.txt', 'r+') as cadastro_motos:
            textoMoto = cadastro_motos.readlines()
            confirm = 'sS'
            for moto in textoMoto:
                if placa in moto:
                    print('Veículo selecionado:')
                    print(moto)
                    confirm = str(input('Deseja vender o veículo?(S/N)\n'))
                    if confirm in 'sS':
                        with open ('lista_vendas.txt', 'a') as lista_vendas:
                            salvar = lista_vendas.write(moto)
                        textoMoto.remove(moto)
                        cadastro_motos = open("cadastro_motos.txt", "w")
                        cadastro_motos.writelines(textoMoto)
